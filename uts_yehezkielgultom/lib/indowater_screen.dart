...
class Indowater extends StatefulWidget {
...
class _ProductDetailsScreenState extends State<Indowater> {
  int quantity = 1;
  double price = 5500.0; // Harga per produk
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushNamed(context, '/Bayar', arguments: 'Indowater');
              },
              child: Text('Bayar'),
