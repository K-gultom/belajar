...
class _ProductDetailsScreenState extends State<Oasis> {
  int quantity = 1;
  double price = 8500.0; // Harga per produk
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushNamed(context, '/Bayar', arguments: 'Pembayaran Diproses');
              },
              child: Text('Bayar'),
